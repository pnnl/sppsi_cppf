...
!
c ref(1): Zhao et al., IJP 80 (2016) 38-55
c ref(2): Ma et al., Acta Materialia 54 (2006) 2169-2179

c Alt+x:print-to-pdf
c compile with ./compile_fcc_dislocation1.pbs
c chmod 777 compile_fcc_dislocation1.pbs
      ...
      real*8 nsp(mp0,3,nss0),bsp(mp0,3,nss0) !each grain
      ...
      real*8 gammas_dot(nss0,nx,ny,nz) 
      ...
      character*19 filenamepgm1,filenamepgm2,filenamepgm3,filenamepgm4 
...
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
      ...
      close(1)
c
c  To calculate dislocation densities, the following inputs are needed
      open(unit=11,file='gammas_dot.dat') !read output from DAMASK
       do n=1,nss0
        do k=1,nz 
        do j=1,ny
        do i=1,nx
         read(11,110) gammas_dot(n,i,j,k),msig(n,i,j,k)
!         msig(n,i,j,k)=schmid(1,1,n)*sigp(1)+schmid(1,2,n)*sigp(6) !schmid:sig
!     &                                +schmid(1,3,n)*sigp(5) !for calculating 
!     &          +schmid(2,1,n)*sigp(6)+schmid(2,2,n)*sigp(2) !Eq.(19) of ref(3)
!     &                                +schmid(2,3,n)*sigp(4)
!     &          +schmid(3,1,n)*sigp(5)+schmid(3,2,n)*sigp(4)
!     &                                +schmid(3,3,n)*sigp(3)
! ref(3): Int J Plasticity 32-33 (2012) 59-69 by RA Lebensohn et al.
        enddo
        enddo
        enddo
       enddo !do n=1,nss0
